...
namespace SignalR_Microservice.Services
{
    public class QueueSendService
    {
        ...
        public QueueSendService(IHubContext<QueueHub> hubContext)
        {
            QueueHub = hubContext;
        }
        ...
        public async Task SendReceiveQueueCountAll(int index)
        {
            await QueueHub.Clients.All.SendAsync("ReceiveQueueCount", index);
        }
